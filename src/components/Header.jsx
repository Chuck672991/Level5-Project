      ...
      <Container>
        <div
          style={{
            width: "100%",
            background:
              "linear-gradient(143deg, rgba(0,0,0,1) 12%, rgba(0,0,0,1) 51%, rgba(7,4,66,0.9051995798319328) 100%)   ",
          }}
        >
            ...
            <Grid item xs={4} md={3} lg={6} xl={6}>
              <Box
                sx={{
                  ...
                  paddingTop: { sm: "9vh", lg: "13vh", xl: "15vh" },
                }}
              >
                <Typography
                  sx={{
                ...
                <Typography
                  sx={{
                    borderBottom: "0.4vh solid #8868F9",
                    maxWidth: {
                      xs: "16vh",
                      sm: "45vh",
                      md: "37vh",
              ...
              <Grid item xs={12}>
                <img
                  src="./thumbnail_Master_logo_white 2 (1).svg"
                  alt="level five logo "
                  style={{
                    paddingBottom: "",
                    paddingLeft: isSmallScreen ? "4vh" : "8vh",
                    width: isSmallScreen ? "10vh" : "40vh",
                  }}
                />
              </Grid>
            </Grid>
            ...
            <Grid item xs={6} md={8} lg={6} xl={6}>
              <Box
                sx={{
                  ...
                  paddingTop: { xs: "2vh", md: "4vh" },
                  paddingBottom: { xs: "5vh", md: "30vh" },
                  opacity: {
                    xs: "23%",
                    sm: "23%",
                    md: "50%",
